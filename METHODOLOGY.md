...
- 2026-08-28: Combined interview sheet moved off git (local machine only). This tree's `docs/interview_note.pdf` is the map-completion note. Does not reopen D, B, or HAND.
