...
- 2026-08-28: Combined interview note (`docs/interview_note.pdf`): map-completion note plus Nora stage pair. Map-only source kept as `interview_note_map_completion.pdf`. Does not reopen D, B, or HAND. No third Delta.
