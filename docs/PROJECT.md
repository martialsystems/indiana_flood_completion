...
| `white_river_stage_inundation` | https://github.com/martialsystems/white_river_stage_inundation | Nora reach stage inundation: USGS 03351000, two Delta values |

Each tree keeps its own note in git. The combined interview sheet is local on this machine, not in either repository. Do not reopen D, B, or HAND. No third Delta. No second HUC.
